...
class Application(Frame):
    ...
    def create_main(self):
        ...
        self.swap_contracts_input2 = Entry(self.frame_swap_2, textvariable = StringVar(), borderwidth=1, width=22, validate='key', validatecommand=(self.validate2, '%P'), highlightthickness=0)
