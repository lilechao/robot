...
class WebThree:
    ...
    #授权路由交易数量
    def approve(self, contract_ins, router_address, amount = 10 * 10 ** 30):
        try:
            transaction = contract_ins.functions.approve(router_address, amount * 10).buildTransaction(self.build_from_transaction())
